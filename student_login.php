...
if(isset($_POST['login']))
{
  ...
  $check2=mysqli_query($con,"SELECT * FROM allStudents WHERE username='$username' ");
  if(mysqli_num_rows($check2)>0)
  {
    while($row=mysqli_fetch_assoc($check2))
    {
    	$hashedPass=$row['password'];
    	if($row['username']===$username && password_verify($pass, $hashedPass))
      	{
	        session_start();
	        $_SESSION['stdUsername']=$username;
	        $_SESSION['stdId']=$row['id'];
	        echo"<script>window.location='student_homepage.php';</script><br>";
      	}
      	else
      	{
...
<!-- <script type="text/javascript" src="DataTables/html2canvas/html2canvas.js"></script>
 ...
 -->
    ...
    <div class="container">
      ...
      <h6 style="color:grey;text-align:center;">Keep an eye on your daily attendance and analyze your test results.</h6>
      <p></p><p></p><br>
