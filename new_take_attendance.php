...
$tableNameStd=$_SESSION['profUsername']."_students";
$className=$_GET['className'];
$classDiv=$_GET['division'];
$tableNameCal=$_SESSION['profUsername']."_calender";
...
if (mysqli_num_rows($result) > 0)
	...
	echo "<script>alert('You have no such class');window.location='go_to_class.php?className=$className&division=$classDiv';</script>";
        ...
        if (isset($_POST['presenteeSaveBtn']))
        {
            ...
            if(count($presentStdIds)>0)
            {
                ...
                {
                    echo "<script>alert('Everything updated succesfully');window.location='go_to_class.php?className=$className&division=$classDiv';</script>";
...
<script src="https://kit.fontawesome.com/b5f9813c1e.js" crossorigin="anonymous"></script>
    ...
    <div class="container">
    <h4 style="text-align:center;margin-top:1%;"><span style="background-color:white;"><span class="shadow" style="background-color:white;">&nbsp Arse</span><span class="shadow" style="color:white;background-color:#008ef2;">NULL &nbsp</span></span></h4>
    <p></p><p></p>
